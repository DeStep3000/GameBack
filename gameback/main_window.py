...
from pathlib import Path
from tkinter import Tk, Canvas, Entry, Button, PhotoImage, Scrollbar, Frame, Toplevel, Label
...
class MainWindow(Frame):
    ...
    def generate_text_blocks(self, texts):
        ...
        for text in texts:
            ...
            self.canvas.create_text(200, y_position + 25, anchor="nw", text=text, fill="#123C69", font=("Inter SemiBold", 16))
            y_position += 60